...
The committed spec inventory is **17 modules** (the authoritative table lives
...
`loom_multishot` / `loom_order`, each with clean cfg(s) + buggy-cfg
counterexamples (71 buggy cfgs total). Three of the Phase-0 planned nine
...
| I-27 | Trusted path: SAK unspoofable; console-ATTACH (elevation gate) distinct from console-OWNER (Ctrl-C target) per `@2608c88` | IDENTITY-DESIGN §9.8 + ARCH §17.1 prose + tests |
