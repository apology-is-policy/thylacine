...
- **poll** -- `kernel/poll.c`, `poll.h` (register-then-observe; since 2026-09-21 the RE-ARM: a wake is a hint, clear-then-re-sample, 0 only at the deadline; `specs/poll.tla`) ...
