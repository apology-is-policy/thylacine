...
cfg(s) + buggy-cfg counterexamples (145 buggy cfgs as of 2026-09-21 -- re-derive
...
- **poll** -- `kernel/poll.c`, `poll.h` (register-then-observe; since 2026-09-21 the RE-ARM: a wake is a hint, every pass RE-REGISTERS, 0 only at the deadline; the loop owns death + stop; list locks irqsave; `specs/poll.tla`) ...
