...
- **FORAGE: the npxf secure channel -- a second implementation of a hand-rolled AEAD protocol, on a network-facing surface (`docs/FORAGE-DESIGN.md`)** -- NEW `usr/forage/src/npxf.rs` (PURE, syscall-free: the psk / transcript / X25519+contributory check / HKDF sc ...
