...
- **#50 path-mutation family (`SYS_OPEN_CREATE`=108 + the phenotype openat-O_CREAT/mkdirat/unlinkat/renameat rows)** -- `kernel/syscall.c` (`sys_open_create_kpath_for_proc` + the extracted `spoor_create_install`/`spoor_unl ...
