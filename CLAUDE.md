...
- **poll** -- `kernel/poll.c`, `poll.h` (register-then-observe; since 2026-09-21 the RE-ARM: a wake is a hint, every pass RE-REGISTERS, 0 only at the deadline; the loop owns death + stop; list locks irqsave; the noise backstop; `specs/poll.tla`) ...
