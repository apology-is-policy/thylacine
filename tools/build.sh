...
EOF
    ...
    local usr_bins=( "hello" "joey" "pipe-probe" "attach-probe" "stratumd-stub" "stub-driver" "stub-fs-probe" "stub-walk-probe" "thread-probe" )
    ...
    local pouch_bins=( "pouch-hello" "pouch-hello-stdio" "pouch-hello-printf" "pouch-hello-malloc" "pouch-hello-threads" "pouch-hello-poll" "pouch-hello-getrandom" "pouch-hello-sockets" "pouch-hello-signals" "pouch-hello-sodium" "pouch-hello-argv" )
    ...
    # P6-pouch-stratumd-boot (sub-chunk 16b-beta): copy the boot pool
    # keyfile into the ramfs at /etc/stratum/system.key per the K1
    # initramfs-literal-key boot decision (scripture commit e82e945).
    ...
    if [[ -f "$keyfile_src" ]]; then
        mkdir -p "$ramfs_src/etc/stratum"
        cp "$keyfile_src" "$ramfs_src/etc/stratum/system.key"
        chmod 0400 "$ramfs_src/etc/stratum/system.key"
    fi
...
build_pouch_progs() {
    ...
    local prog
    for prog in pouch-hello pouch-hello-stdio pouch-hello-printf pouch-hello-malloc pouch-hello-threads pouch-hello-poll pouch-hello-getrandom pouch-hello-sockets pouch-hello-signals pouch-hello-sodium pouch-hello-argv; do
