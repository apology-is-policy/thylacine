...
EOF
    ...
    local usr_rs_bins=( "hello-rs" "mmio-probe" "irq-probe" "virtio-blk-probe" "virtio-blk-rw" "virtio-net-probe" "virtio-net-arp" "virtio-net-loop" "virtio-input" "virtio-gpu" "irq-bench" "corvus" "alloc-smoke" "u-test" "ut" )
