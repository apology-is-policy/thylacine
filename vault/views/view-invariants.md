...
|---|---|---|---|---|
| I-1 | [[inv-i1]] | prose | sub-kernel-devsrv | prose |
...
| I-9 | [[inv-i9]] | spec | sub-kernel-ninep-client, sub-kernel-ninep-dev9p-poll, sub-kernel-srvconn | spec-reader-frame, spec-9p-client, spec-net-poll, spec-net-poll-teardown, gate-smp |
<!-- generated:end -->
