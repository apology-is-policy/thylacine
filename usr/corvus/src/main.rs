...
use libthyla_rs::{
    ...
    T_CAP_CHOWN, T_CAP_DAC_OVERRIDE, T_CAP_DEBUG, T_CAP_GRANT_FLAG_PROPAGATING,
    T_CAP_POST_SERVICE, T_CAP_HOSTOWNER, T_CAP_JIT, T_CAP_KILL, T_CONSOLE_EPISODE_ARM, T_CONSOLE_EPISODE_END, T_OPATH,
...
static CLEARANCE_LEVELS: &[ClearanceLevel] = &[
    ...
    ClearanceLevel {
        name: b"imperium",
        caps: T_CAP_DAC_OVERRIDE | T_CAP_CHOWN | T_CAP_KILL | T_CAP_POST_SERVICE,
...
fn caps_names(caps: u64, out: &mut Vec<&'static [u8]>) {
    const TABLE: &[(u64, &[u8])] = &[
        ...
        (T_CAP_JIT, b"CAP_JIT"),
        (T_CAP_POST_SERVICE, b"CAP_POST_SERVICE"),
    ];
    let mut rest = caps;
