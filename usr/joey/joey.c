...
#include "../pouch-hello/pouch-census.h"
...
static int do_pouch_hello_smoke(void) {
    ...
    // marker, and every new leg would be green without having run. The strings
    // live in ONE header the prover and this file both read (pouch-census.h).
    // Same for the three below.
    static const char pm_expect[] = POUCH_CENSUS_MALLOC;
   ...
   building at all. APPEND NEW /net PROBES ABOVE THIS LINE. */
    ...
    // absence is environment-dependent and soft). PTY-2a-2.
    {
        ...
        // by this point (the go-arc env block creates it). Boot-fatal.
        {
            ...
            const char pf_expect[] = POUCH_CENSUS_FOPEN;
