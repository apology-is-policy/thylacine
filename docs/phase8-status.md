...
pure userspace, kernel byte-unchanged). Next: net-6b-2b (the kernel `dev9p.poll`
slot + the poll-pump kthread), net-6b-3 (the pouch `poll()` translation), net-6b-4
