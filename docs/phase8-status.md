...
deferred (a pollable IRQ fd is a kernel ABI surface). net-2d (the focused audit)
then net-3..net-8 (listen/accept, cs/dns, socket-compat, dev9p.poll, TLS/NTP,
exit criteria) resume from there.
