...
no in-guest peer). **net-6b is IN PROGRESS** (the `dev9p.poll` bridge — the one
...
`net-6b` UDP E2E). Next: net-6b-3 (the pouch `poll()` translation), net-6b-4
(the focused audit). net-7 (TLS/NTP), net-8 (exit criteria + arc audit) follow.
