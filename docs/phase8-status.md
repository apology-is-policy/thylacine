...
`DeviceRemoved` teardown is preserved. net-2b-2..net-8 (the 9P `/net` server +
mount, listen/accept, cs/dns, socket-compat, dev9p.poll, TLS/NTP, exit criteria)
resume from there.
