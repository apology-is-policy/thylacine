...
slirp), proving the whole lower stack (Ethernet/ARP/UDP/DHCP). net-2b..net-8
(the 9P `/net` server, listen/accept, cs/dns, socket-compat, dev9p.poll,
TLS/NTP, exit criteria) resume from there.
