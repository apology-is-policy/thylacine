...
dependency; pure userspace. net-3c (ICMP ping), net-3d (audit + the inbound-accept
+ UDP-loopback E2E), then net-4..net-8 (cs/dns, socket-compat, dev9p.poll, TLS/NTP,
