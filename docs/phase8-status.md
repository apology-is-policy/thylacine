...
runtime regression — + UDP datagram + ICMP echo). **net-3 is DONE.** net-4..net-8
(cs/dns, socket-compat, dev9p.poll, TLS/NTP, exit criteria) follow.
