...
byte-unchanged. **net-4d..net-8** (the net-4 audit, socket-compat, dev9p.poll,
...
- **net-4a** `/net/cs` + the compiled-in ndb. **DONE.** **net-4b** `/net/dns` +
  ...
  DHCP-into-config. **DONE.** **net-4d** the focused net-4 audit + close. **net-5**
  socket-compat pouch patch.
