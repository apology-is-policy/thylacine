...
is in. Next is **Loom-6c** (the OWED multi-in-flight SMP harness + the focused
formal audit over the whole 6a+6b surface + the SMP gate) + **Loom-6d** (the
native libthyla-rs API + the bench). The fid-lifecycle ops (WALK / LOPEN /
