...
joey-spawned post-pivot, witnessed by the ci-smp-gate multi-boot) are **LANDED**;
next is **6d-3** (the latency bench + the Tapestry seam doc), then **6d-4** (the
focused audit + the Loom arc close). The fid-lifecycle ops (WALK / LOPEN /
