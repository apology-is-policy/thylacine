...
across all five Loom closed lists). Next is **Loom-6d** (the native libthyla-rs API
+ the bench + the concurrent harness). The fid-lifecycle ops (WALK / LOPEN /
