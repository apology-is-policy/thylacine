...
gate) is **LANDED**; next is **Loom-6d-2** (the concurrent two-thread-same-`loom_fd`
+ cross-Proc-death SMP stress harness + the positive dev9p async round-trip), then
**6d-3** (the latency bench + the Tapestry seam doc) and **6d-4** (the focused audit
+ the Loom arc close). The fid-lifecycle ops (WALK / LOPEN /
