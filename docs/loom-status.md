...
`impl tapestry::Loom for libthyla_rs::loom::Ring` handoff) are **LANDED**; next is
**6d-4** (the focused Opus audit over the whole 6d surface + the Loom arc close).
The fid-lifecycle ops (WALK / LOPEN /
