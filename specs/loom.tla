...
UserProduce(o, a) ==
    ...
    /\ UNCHANGED <<snap_arg, acted_arg, snap_obj, acted_obj, cqe_posted, reg, cq, torn>>
...
UserMutateSqe(o, a) ==
    ...
    /\ a # sqe_arg[o]
    /\ sqe_arg' = [sqe_arg EXCEPT ![o] = a]
    /\ UNCHANGED <<phase, snap_arg, acted_arg, snap_obj, acted_obj, cqe_posted, reg, cq, torn>>
...
UserRegister(obj) ==
    ...
    /\ obj # reg
    /\ reg' = obj
    /\ UNCHANGED <<phase, sqe_arg, snap_arg, acted_arg, snap_obj, acted_obj, cqe_posted, cq, torn>>
...
Consume(o) ==
    ...
    /\ UNCHANGED <<sqe_arg, acted_arg, acted_obj, cqe_posted, reg, cq, torn>>
...
Dispatch(o) ==
    ...
    /\ UNCHANGED <<sqe_arg, snap_arg, snap_obj, cqe_posted, reg, cq, torn>>
...
ReplyArrives(o) ==
    ...
    /\ UNCHANGED <<sqe_arg, snap_arg, acted_arg, snap_obj, acted_obj, cqe_posted, reg, cq, torn>>
...
BuggyDoublePost(o) ==
    ...
    /\ cqe_posted[o] < 2
    /\ cqe_posted' = [cqe_posted EXCEPT ![o] = cqe_posted[o] + 1]
    /\ UNCHANGED <<phase, sqe_arg, snap_arg, acted_arg, snap_obj, acted_obj, reg, cq, torn>>
...
Reap(o) ==
    ...
    /\ cq'    = cq \ {o}
    /\ UNCHANGED <<sqe_arg, snap_arg, acted_arg, snap_obj, acted_obj, cqe_posted, reg, torn>>
