...
(*                                                                         *)
(* I-7 (VMO refcount + mapping lifecycle) is OUT OF SCOPE — covered by    *)
(* `vmo.tla` because it concerns memory-object lifetime, not handle       *)
(* policy.                                                                 *)
(*                                                                         *)
(* Modeling decisions:                                                     *)
(*                                                                         *)
(*   Kobj universe is partitioned into TxKObjs (transferable: Process,   *)
(*   Thread, VMO, Chan) and HwKObjs (non-transferable: MMIO, IRQ, DMA,   *)
